package com.jjz.energy.util.glide;
 ...
 * @function Glide 加载工具类
 * 功能包括加载图片，圆形图片，圆角图片，指定圆角图片，模糊图片，灰度图片 （后续根据需要继续跟进）
 * 目前固定占位图，如需自定义占位图，自行增加方法，重载对应方法，增加参数即可
 */
public class GlideUtils {


    public static final int placeholderSoWhite = R.color.color_primary_f5;
    public static final int errorSoWhite = R.color.color_primary_f5;
...
//                .bitmapTransform(new GlideCircleTransformation())
     ...
     * 加载圆形图片
     */
    public static void loadCircleImageNoCenterCrop(Context context, String url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .circleCrop()//设置圆形
                .placeholder(placeholderSoWhite)
                .error(errorSoWhite)
     ...
     * 加载圆形图片
     */
    public static void loadCircleImage(Context context, String url, ImageView imageView,int place ,int error) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .placeholder(place)
...
//                .bitmapTransform(new GlideCircleTransformation())
     ...
     * @param error     加载失败
     */
    public static void loadCircleImageError(Context context, String url, ImageView imageView, int loading, int error) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .placeholder(loading)
    ...
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .bitmapTransform(new GlideRoundTransform(context,5))
                .placeholder(placeholderSoWhite)
                .error(errorSoWhite)
                //.priority(Priority.HIGH)
                .diskCacheStrategy(DiskCacheStrategy.ALL);
     ...
     * 加载圆角图片 指定 圆角
     */
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView,int rounds) {
        RequestOptions options = new RequestOptions()
                .bitmapTransform(new GlideRoundTransform(context,rounds))
                .placeholder(placeholderSoWhite)
                .error(errorSoWhite)
                //.priority(Priority.HIGH)
                .diskCacheStrategy(DiskCacheStrategy.ALL);
