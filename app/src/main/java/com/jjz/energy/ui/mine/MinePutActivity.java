 ...
 */
public class MinePutActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        list.add("");
        list.add("");
        MineListAdapter mineListAdapter = new MineListAdapter(R.layout.item_mine_put,list);
        rvMinePut.setLayoutManager(new LinearLayoutManager(mContext));
        rvMinePut.setAdapter(mineListAdapter);
    }
