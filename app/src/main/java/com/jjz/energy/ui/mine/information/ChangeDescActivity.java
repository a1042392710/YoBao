 ...
 */
public class ChangeDescActivity extends BaseActivity <MineInformationPresenter> implements IPersonalInformationView {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_toolbar_right:
                mPresenter.putMineInfo(PacketUtil.getRequestPacket(Utils.stringToMap("desc",etDesc.getText().toString().trim())),"");
                break;
        }
    }
    ...
    public void isSuccess(LoginBean data) {
        ...
        setResult(10,new Intent().putExtra("nick_name",etDesc.getText().toString().trim()));
        finish();
    }
