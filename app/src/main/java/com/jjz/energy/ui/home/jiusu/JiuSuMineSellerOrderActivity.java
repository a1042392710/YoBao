 ...
 */
public class JiuSuMineSellerOrderActivity extends BaseActivity {
    ...
    protected int layoutId() {
        return R.layout.act_mine_seller_order;
    }

    @Override
    protected void initView() {
        tvToolbarTitle.setText("卖家订单管理");
        //初始化数据
        mFragments = new ArrayList<>();
        //未完成
        Fragment fragment1 = new JiuSuMineSellerOrderFragment();
        Bundle bundle = new Bundle();
        bundle.putString("status","0");
        fragment1.setArguments(bundle);
        //已完成
        Fragment fragment2 = new JiuSuMineSellerOrderFragment();
