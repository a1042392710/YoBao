...
package com.jjz.energy.zxing.camera;
...
import com.jjz.energy.zxing.android.CaptureActivityHandler;
...
//    }
    ...
    public void switchFlashLight(CaptureActivityHandler handler) {
        ...
        if (flashMode.equals(Camera.Parameters.FLASH_MODE_TORCH)) {
            ...
            msg.what = ZxConstant.FLASH_CLOSE;


        } else {
            /*打开闪光灯*/
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
            msg.what = ZxConstant.FLASH_OPEN;
        }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            ...
            int actionbarHeight = context.getResources().getDimensionPixelSize(R.dimen.zxing_toolbar_height);
