...
import com.jjz.energy.zxing.bean.ZxingConfig;
import com.jjz.energy.zxing.camera.CameraManager;
import com.jjz.energy.zxing.common.ZxConstant;
import com.jjz.energy.zxing.decode.DecodeImgCallback;
import com.jjz.energy.zxing.decode.DecodeImgThread;
import com.jjz.energy.zxing.decode.ImageUtil;
import com.jjz.energy.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*先获取配置信息*/
        try {
            config = (ZxingConfig) getIntent().getExtras().get(ZxConstant.INTENT_ZXING_CONFIG);
        } catch (Exception e) {
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == ZxConstant.FLASH_OPEN) {
    ...
    public void handleDecode(Result rawResult) {
        ...
        intent.putExtra(ZxConstant.CODED_CONTENT, rawResult.getText());
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.flashLightLayout) {
            ...
            startActivityForResult(intent, ZxConstant.REQUEST_IMAGE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ZxConstant.REQUEST_IMAGE && resultCode == RESULT_OK) {
