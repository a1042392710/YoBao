package com.jjz.energy.widgets.address_select.db.manager;
...
import com.jjz.energy.widgets.address_select.bean.AdressBean;
...
import com.jjz.energy.widgets.address_select.db.AssetsDatabaseManager;
import com.jjz.energy.widgets.address_select.db.TableField;

import java.util.ArrayList;
import java.util.List;

import static com.jjz.energy.widgets.address_select.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static com.jjz.energy.widgets.address_select.db.TableField.ADDRESS_DICT_FIELD_ID;
import static com.jjz.energy.widgets.address_select.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
...
public class AddressDictManager {
    ...
    public String getProvince(String provinceCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_ID+"=?", new String[]{provinceCode});
    ...
    public String getCity(String cityCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_ID+"=?", new String[]{cityCode});
           if(cursor!=null && cursor.moveToFirst()){
               City city =  new City();
               city.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
               city.code = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_CODE));
    ...
    public String getCounty(String countyCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_ID+"=?", new String[]{countyCode});
           if(cursor!=null && cursor.moveToFirst()){
               County county = new County();
               county.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
               county.code = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_CODE));
    ...
    public String getStreet(String streetCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_ID+"=?", new String[]{streetCode});
        if(cursor!=null && cursor.moveToFirst()){
            Street street = new Street();
            street.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
            street.code = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_CODE));
