...
public class DatePickerView extends View {
    ...
    private float mMaxTextSize = 90;
    private float mMinTextSize = 50;
    private float mMaxTextAlpha = 205;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mMinTextSize = mMaxTextSize / 1.7f;
        isInit = true;
        invalidate();
    }
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.date_picker_text_one));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.date_picker_text_two));
    }
     ...
     * 关闭Handle和Timer
     */
    public void stopTimerAndHandle(){
